...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            ...
            <!-- 显示/隐藏菜单 -->
            <a href="javascript:;" class="seraph hideMenu layui-icon-shrink-right layui-icon"></a>
            <!-- 顶部右侧菜单 -->
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="/images/face.jpg" class="layui-nav-img userAvatar" width="35"
                                                height="35"><cite class="adminName">${USER_IN_SESSION.loginname}</cite></a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <p>你好！<span class="userName">${USER_IN_SESSION.loginname}</span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
    ...
    <div class="layui-footer footer">
        <p><span>@2021 Lizbeth9421</span></p>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "/menu/loadMenuJson" //获取菜单json地址
        });
